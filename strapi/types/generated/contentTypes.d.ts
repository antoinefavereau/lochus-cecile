...
export interface ApiAccueilAccueil extends Struct.SingleTypeSchema {
  ...
  attributes: {
    competences: Schema.Attribute.Component<'accueil.competence', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cv: Schema.Attribute.Media<'files'> & Schema.Attribute.Required;
    experiences: Schema.Attribute.Component<'accueil.parcours', true>;
    formations: Schema.Attribute.Component<'accueil.parcours', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::accueil.accueil'
