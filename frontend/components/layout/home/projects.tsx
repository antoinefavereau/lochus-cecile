  ...
  return (
    <section className="pb-16">
      <div ref={containerRef} className="flex flex-col gap-8">
        <div
          ref={contentRef}
          className="relative flex flex-col md:gap-40 px-8 py-[40vh] min-h-screen"
        >
          ...
          {projects.map((project, index) => (
            <Link
              ...
              key={project.titre}
              className={`relative py-16 text-5xl xs:text-6xl md:text-7xl lg:text-8xl font-bold text-center ${
