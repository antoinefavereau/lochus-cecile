...
export default function Projects() {
  ...
  return (
    <section className="flex flex-col gap-8">
      ...
      <Link className="group flex overflow-hidden" href="/projets">
        {/* This is a marquee so we need to duplicate this text at least 20 times with a js loop */}
        {new Array(20).fill(0).map((_, index) => (
          <div key={index} className="shrink-0 flex items-center gap-4 pe-16 text-4xl animate-[horizontalMarquee_3s_linear_infinite]">
